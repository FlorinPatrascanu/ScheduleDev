...
function buildCard(rooms, obj) {
	...
	var output = "";
	output += '<div class="topic" style="position: absolute; left:'+offsetLeft+ 'px; top: '+offsetTop+'px; height: '+cardHeight+'px; width: '+cardUnitHorizontal+'px;">';
...
function renderTimeslots(arr) {
	...
	_.map(arr, function(hour){
		output += '<div class="timeslot">'+hour+'</div>'
	});
